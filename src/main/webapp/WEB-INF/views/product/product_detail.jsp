...
<head>
    ...
    <title>Shop</title>
    <link rel="stylesheet" href="http://localhost:9000/myshop/resources/css/style.css">
...
<form action="">
    ...
    <div class="product_info" id="product_Info">
        <div class="img" id="img">
			<img src="http://localhost:9000/myshop/resources/images/4dda8b6ed915b478044d8db587d11da7.jpeg" alt="" class="big_img">
			<ul class="thumb_img">
        ...
        <h3>22SS GUCCI 구찌 키즈 로우탑 스니커즈 멀티 647075 HVKF0</h3>
		<table>
			<colgroup>
