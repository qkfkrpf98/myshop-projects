...
public class Naver_Sens_V2 {
	...
	public void send_msg(String pnumber, String rand) {
        ...
        String accessKey = "ya5pALWlosE48Zy5ugLy";                     						// 개인 인증키
        String secretKey = "XwTOQVUksnlyiuWyaaXG0HEFUwLXKE5gaThhm8b7";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
        String serviceId = "ncp:sms:kr:293558416534:myshop";        									// 프로젝트에 할당된 SMS 서비스 ID
